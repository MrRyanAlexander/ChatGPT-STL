...
const SIMULATED_RESPONSES: Record<string, Record<string, string>> = {
  ...
  "handyman": {
    "How do I find a reliable handyman in St. Louis?": "Finding a reliable handyman in St. Louis:\n\n1. Personal recommendations:\n   • Ask neighbors, friends, and family for referrals\n   • Neighborhood Facebook groups and Nextdoor app are great resources\n\n2. Online services:\n   • Angi (formerly Angie's List) - verified reviews of local services\n   • HomeAdvisor - pre-screened professionals\n   • Thumbtack - compare quotes from local handymen\n\n3. Verification steps:\n   • Check for proper licensing (required in St. Louis City and County)\n   • Verify insurance coverage\n   • Read multiple reviews across different platforms\n   • Ask for references from previous customers\n\n4. Get written estimates from 2-3 handymen before deciding\n\nFor urgent needs, services like Task Rabbit can connect you with same-day help, though rates may be higher.",
    "What's the average cost of handyman services in St. Louis?": "Average cost of handyman services in St. Louis:\n\n• Hourly rates: $60-$125 per hour depending on experience and specialization\n\n• Minimum charges: Many handymen have a 1-2 hour minimum service charge ($75-$200)\n\n• Common project costs:\n  - Drywall repair: $150-$350\n  - Toilet replacement: $150-$300\n  - Ceiling fan installation: $100-$250\n  - Door repair/replacement: $150-$400\n  - Deck repair: $20-$50 per square foot\n\n• Additional considerations:\n  - Material costs are usually extra\n  - Some charge travel fees for distant locations\n  - Emergency/weekend services typically cost 25-50% more\n  - Licensed and insured handymen generally charge more\n\nPrices tend to be higher in Clayton, Ladue and Frontenac areas, and lower in parts of North and South County."
  },
  "dierbergs": {
